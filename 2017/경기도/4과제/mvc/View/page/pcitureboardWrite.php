    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <form class="form-horizontal" action="/post/pciturewrite/<?php echo $idx ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group  ">
                        <label for="upimg" class="col-sm-2 control-label">이미지</label>
                        <div class="col-sm-10">
