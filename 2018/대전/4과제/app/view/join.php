    ...
    <div class="container">
      ...
      <div class="col-8 mx-auto mt-2">
        <div class="row">
          ...
          <form class="card" action="/member/join" method="post">
              ...
              <div class="form-group">
                ...
                <div>
                  <select class="form-control custom-select" name="type">
                    ...
                    <option value="2">가맹회원</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                <label class="form-label">전화번호</label>
                <input type="text" name="phone" class="form-control" placeholder="0000-0000-0000형식">
              </div> 
              <div class="form-group">
                  ...
                  <div>
                    <div class="card">
                      <div class="card-header">
                        ...
                        <div class="col-3">
                          <input type="text" name="offset" class="form-control position" readonly="readonly">
                        </div>
