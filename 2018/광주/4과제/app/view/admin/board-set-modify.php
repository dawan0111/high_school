            ...
            <div class="wrap">
                ...
                <form method="post" action="/admin/boardAction" class="board-add-frm" >
                    ...
                    <div class="board-table">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>이름</td>
                                    <td><input type="text" name="name" value="<?php echo $board['name'] ?>"></td>
                                </tr>
                                            ...
                                            <tbody>
                                                <tr class="b_type">
                                                    <td>
                                                        ...
                                                        <span>
                                                            <input type="radio" name="board_type" value="1" <?php echo $board['type'] == 1 ? "checked" : ""; ?>>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span>
                                                            <input type="radio" name="board_type" value="2" <?php echo $board['type'] == 2 ? "checked" : ""; ?>>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span>
                                                            <input type="radio" name="board_type" value="3" <?php echo $board['type'] == 3 ? "checked" : ""; ?>>
                    ...
                    <div class="save-btn">
                        ...
                        <button type="button" onclick="location.href='/admin/boarddelete/<?php echo $board['idx'] ?>'" class="bd-remove" >게시판 삭제</button>
                    </div>
                </form>
